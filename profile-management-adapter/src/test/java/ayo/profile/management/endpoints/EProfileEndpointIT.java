...
public class EProfileEndpointIT {

    @ClassRule
    public static final SpringClassRule SPRING_CLASS_RULE = new SpringClassRule();
    public static final java.lang.String PROFILE_V1_PATH = "/profile/management-service/v1";
    ...
    public static Collection byteParams() {
        return Arrays.asList(new Object[][]{
                {PROFILE_V1_PATH, "customerRegistrationRequestFailure2.json", "customerRegistrationResponseFailure.json", 500},
        });
    }

    public EProfileEndpointIT(String url, String jsonFilename, String jsonFilenameResult, int status) {
        this.url = url;
    ...
    @Test
    public void testEProfileService() throws Exception {
